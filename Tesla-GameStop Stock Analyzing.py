...
def make_graph(stock_data, revenue_data, stock):
    ...
    stock_data_specific = stock_data[stock_data.Date <= '2022--01-05']
...
g_data = BeautifulSoup(html_data, 'html5lib')
...
for row in g_data.find("tbody").find_all('tr'):
    col = row.find_all("td")
    Date = col[0].text
    Revenue = col[1].text
...
# gme_html_pandas_data = pd.read_html(str(g_data))


# In[235]:


# gme_revenue = gme_html_pandas_data[0]
